    ...
    <div className='container mx-auto p-2'>
        <div className='bg-banner my-8 rounded-xl bg-cover bg-center'>
            <div className='w-full h-full rounded-xl p-20 backdrop-brightness-50'>
                ...
                <p className='text-white text-center pb-2 text-xl font-extralight'>Paste your long untidy link to make it short</p>
                <p className='text-white text-center pb-4 text-sm font-thin '>Free tool to shorten a URL or reduce the length of the link</p>
                <form onSubmit={handleSubmit}>
                    <div className="flex">
                            <div className="relative w-full">
                                <div className="absolute inset-y-0 start-0 flex items-center ps-2 pointer-events-none text-slate-800">                    urlshortner.link /
                                </div>
                                    <input 
                                    type="text" 
